...
const Bookmark = () => {
    ...
    return (
        <>
            <div className='hidden lg:flex w-full h-120' name="capture">
                <div data-aos="zoom-in" data-aos-duration="3000">
                    <div style={{ width: "100%", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
                        <div style={{display:"block", marginLeft:"250px"}}>
                            <div>
                            ...
                            <p style={{ fontSize: "1.3rem", color: "white", margin: "70px" }}>Snap Moments, Bookmark your favourite pages for easy navigation</p>
                        </div>
                    </div>
                </div>
            </div>

            <div className='flex lg:hidden w-full h-120' name="capture">
                <div data-aos="zoom-in" data-aos-duration="3000">
                    <div style={{ width: "100%", display: "flex", justifyContent: "center", alignItems: "center", flexDirection: "column" }}>
